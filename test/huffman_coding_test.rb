...
class HuffmanCodingTest < Minitest::Test # huffman_coding
  ...
  def test_encode
    ...
    if RUBY_VERSION < '2'
      ...
      expected_binary = String.new("\xFA\xC6\x88\x00", :encoding => 'BINARY').freeze
      expected_mapping = {
        'A' => '111',
        'B' => '110',
        'C' => '101',
  ...
  def test_encode_when_last_byte_have_8_bits
    ...
    if RUBY_VERSION < '2'
      ...
      expected_binary = String.new("6\x88BwV", :encoding => 'BINARY').freeze
      expected_mapping = {
        'e' => '111',
        '.' => '110',
        't' => '10',
  ...
  def test_encode_with_only_one_kind_of_char
    ...
    if RUBY_VERSION < '2'
      ...
      expected_binary = String.new("\000", :encoding => 'BINARY').freeze
      expected_mapping = { 'T' => '0' }.freeze
    end
